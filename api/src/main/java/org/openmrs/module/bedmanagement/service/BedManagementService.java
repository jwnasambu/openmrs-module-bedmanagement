...
public interface BedManagementService extends OpenmrsService {
	 ...
	 *
	 * @param admissionLocation
	 *            {@link AdmissionLocation}
	 * @param row
	 *            {@link Integer} admission location bed layout row
	 * @param column
	 *            {@link Integer} admission location bed layout column
	 * @return {@link AdmissionLocation}
	 */
	@Authorized({"Edit Admission Locations", "Manage Locations"})
	AdmissionLocation setBedLayoutForAdmissionLocation(AdmissionLocation admissionLocation, Integer row,
			Integer column);
	...
	/**
	 * Unassign all assigned beds from a patient associated with the given visit.
	 * The number of assigned beds for the patient *should* be at most one, but this
	 * function does not assume that.
	 * 
	 * @param visit
	 * @return a List of beds that got unassigned as a result of calling this
	 *         function
	 */
	@Authorized(value = {"Assign Beds", "Edit Admission Locations"}, requireAll = true)
	 ...
	 *
	 * @param limit
	 *            {@link Integer} limit result set, return all result set if limit
	 *            is null
	 * @param offset
	 *            {@link Integer} specify the starting row offset into the result
	 *            set
	 ...
	 *
	 * @param locationUuid
	 *            {@link String} location Uuid, if null location uuid criteria will
	 *            not set
	 * @param bedTypeName
	 *            {@link String} bedTypeName, if null bedTypeName criteria will not
	 *            set
	 * @param status
	 *            {@link BedStatus} bed status, if null status criteria will not set
	 * @param limit
	 *            {@link Integer} limit result set, return all result set if limit
	 *            is null
	 * @param offset
	 ...
	 *            {@link Bed}
	 * @param reason
	 *            {@link String} reason of bed delete
	 */
	 ...
	 *
	 * @param name
	 *            {@link String} bed tag name, if null bed tag name criteria will
	 *            not set
	 * @param limit
	 *            {@link Integer} limit result set, return all result set if limit
	 *            is null
	 ...
	 *
	 * @param name
	 *            {@link String} bed type name, if null bed type name criteria will
	 *            not set
	 * @param limit
	 *            {@link Integer} limit result set, return all result set if limit
	 *            is null
	 ...
	 *
	 * @param locationUuid
	 *            {@link String} location Uuid
	 * @param row
	 *            {@link Integer} bed row
	 * @param column
	 *            {@link Integer} bed column
	 * @return {@link BedLocationMapping}
	 */
	@Authorized(value = "Get Beds", requireAll = true)
	BedLocationMapping getBedLocationMappingByLocationUuidAndRowColumn(String locationUuid, Integer row,
			Integer column);
